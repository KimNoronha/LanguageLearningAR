...
public class LoginActivityTest {
    ...
    public void testUsernameValidation_validEmail() {
        assertTrue(LoginActivity.validateUsername("example@example.com"));
    ...
    public void validateUsername_invalidEmail() {
        ...
        assertFalse(LoginActivity.validateUsername("example"));
        assertFalse(LoginActivity.validateUsername("example@.com"));
        assertFalse(LoginActivity.validateUsername("example.com"));
    }
    ...
    public void validatePassword_validPassword() {
        LoginActivity activity = new LoginActivity();
        assertTrue(LoginActivity.validatePassword("password123"));
    }

    @Test
    public void validatePassword_invalidPassword() {
        LoginActivity activity = new LoginActivity();
        assertFalse(LoginActivity.validatePassword("pass")); // Too short
        assertFalse(LoginActivity.validatePassword("12345678")); // No letters
        assertFalse(LoginActivity.validatePassword("abcdefgh")); // No digits
    }
